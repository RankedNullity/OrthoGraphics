...
{	private GLCanvas myCanvas;
	...
	private Torus myTorus = new Torus(0.5f, 0.2f, 36);
	private int numTorusVertices, numTorusIndices;

	private Vector3f lightLoc = new Vector3f(5.0f, 2.0f, 2.0f);
	...
	private int mvLoc, projLoc, nLoc, enableLightingLoc;
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		enableLightingLoc = gl.glGetUniformLocation(renderingProgram, "enableLighting");
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		renderingProgram = Utils.createShaderProgram("code/vertShader.glsl", "code/geomShader.glsl", "code/fragShader.glsl");
