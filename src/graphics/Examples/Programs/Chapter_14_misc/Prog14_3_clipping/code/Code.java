...
{	private GLCanvas myCanvas;
	...
	private Vector3f torusLoc = new Vector3f(0,0,0);
	private Vector3f cameraLoc = new Vector3f(0,0,3);
	
	private Torus myTorus = new Torus(1.5f, 0.5f, 48);
	...
	private FloatBuffer vals3 = Buffers.newDirectFloatBuffer(3);
	private Matrix4f pMat = new Matrix4f();  // perspective matrix
	private Matrix4f vMat = new Matrix4f();  // view matrix
	private Matrix4f mMat = new Matrix4f();  // model matrix
	private Matrix4f mvMat = new Matrix4f(); // model-view matrix
	private Matrix4f invTrMat = new Matrix4f(); // inverse-transpose
	private int mvLoc, projLoc, nLoc, flipLoc;
