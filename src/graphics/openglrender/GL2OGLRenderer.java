...
public class GL2OGLRenderer extends GLCanvas implements GLEventListener, KeyListener, MouseListener {
	...
	public GL2OGLRenderer(int size) {
	...
	public static void main(String[] args) {
		...
		GL2OGLRenderer cube = new GL2OGLRenderer(size);
