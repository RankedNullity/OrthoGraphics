...
{	private GLCanvas myCanvas;
	...
	private Vector3f cameraLoc = new Vector3f(0,0,2);
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		gl.glBindTexture(GL_TEXTURE_2D, colorTexture); // texture

		gl.glActiveTexture(GL_TEXTURE1);
		gl.glBindTexture(GL_TEXTURE_2D, normalTexture); // normal

		gl.glActiveTexture(GL_TEXTURE2);
		gl.glBindTexture(GL_TEXTURE_2D, heightTexture); // height
